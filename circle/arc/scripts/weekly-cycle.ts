...
const DEFAULT_ARCAIRDROP_CONTRACT = "0x5E67aB874F36897f559F141D47Fc0d4bCDe70209";
...
const DEFAULT_ARCEXPENSE_CONTRACT = "0x746ec074273f916b6a74d1db117a77ff6bdbd860";
const DEFAULT_ARCEVENTTICKETS_CONTRACT = "0xd2b0af66cb7f9b41e620defa4f40c64de8723d43";
const DEFAULT_ARCMARKETPLACE_CONTRACT = "0xaa0f773d76cc6f52c88f889d0defad5afbb6a753";
const DEFAULT_ARCSERVICEBOOKINGS_CONTRACT = "0xa7a17b35c1a5e85a98513e63134983d2eed0e72b";
const DEFAULT_ARCDONATION_CONTRACT = "0x53998bd1060dbe9950019719087088eda9eaa3ae";
const DEFAULT_ARCPREORDER_CONTRACT = "0x3128486261a2222147fa1deb473e35aebe08d069";
const DEFAULT_ARCPAYROLL_CONTRACT = "0xbb04cc4983802f9a7e4aea048a5e675c89f8c9ea";
const DEFAULT_ARCREFUNDABLEDEPOSIT_CONTRACT = "0xf307c49d66189849e9cf2ee5a370af030614c936";
...
const DEFAULT_ARCAUCTION_CONTRACT = "0x239d4963e7df648204b912621f8d0f823b55399b";
const DEFAULT_ARCRENTAL_CONTRACT = "0x62592aa9af5edd5a72f01ea23366cdb001e99217";
...
const validationPlans: ValidationPlan[] = [
  {
    sendAmount: "0.007",
    swapAmount: "0.01",
    swapTokenIn: "USDC",
...
const productPlans: ProductPlan[] = [
  {
    ...
    invoiceAmount: "0.01",
    quoteAmount: "0.002",
    quoteAcceptance: "accepted-validation-quote",
    quoteSettlement: "settled-validation-quote",
    escrowAmount: "0.004",
    escrowOutcome: "release",
    escrowDisputeAmount: "0.0015",
    escrowDisputeOutcome: "refund",
    escrowDisputeEvidence: "evidence-validation-delivery-mismatch",
    escrowDisputeResolution: "resolved-validation-refund",
    ...
    vaultWithdraw: "0.001",
    pollChoice: "Yes",
    pollReason: "validates the governance flow",
    pollDurationMinutes: "60",
    airdropAmount: "0.004",
    airdropDurationMinutes: "60",
    bountyReward: "0.004",
    bountySubmission: "accepted-validation-work",
    ...
    marketplaceFulfillment: "fulfilled-validation-market-order",
    servicePrice: "0.0035",
    serviceMaxBookings: "5",
    serviceCompletion: "completed-validation-service-booking",
    workOrderAmount: "0.002",
    workOrderSubmission: "submitted-validation-work-order",
    workOrderApproval: "approved-validation-work-order",
    donationGoal: "0.02",
    donationAmount: "0.003",
    donationMessage: "arc-validation-donation",
    preorderPrice: "0.005",
    preorderMaxSupply: "5",
    preorderFulfillment: "fulfilled-validation-preorder",
    payrollAmount: "0.004",
    payrollClaim: "claimed-validation-payroll",
    refundableDepositAmount: "0.004",
    refundableDepositOutcome: "refund",
    refundableDepositReason: "returned-validation-deposit",
    installmentAmount: "0.003",
    installmentCompletion: "completed-validation-installments",
    vestingAmount: "0.003",
    vestingClaim: "claimed-validation-vesting",
    giftCardAmount: "0.003",
    giftCardRedeem: "redeemed-validation-gift",
    rewardAmount: "0.003",
    rewardClaim: "claimed-validation-reward",
    couponAmount: "0.003",
    couponClaim: "claimed-validation-coupon",
    referralAmount: "0.003",
    referralClaim: "claimed-validation-referral",
    cashbackAmount: "0.003",
    cashbackClaim: "claimed-validation-cashback",
    auctionMinBid: "0.003",
    auctionRaiseBid: "0.004",
    auctionSettlement: "settled-validation-auction",
    rentalFee: "0.0015",
    rentalDeposit: "0.003",
    rentalDamageFee: "0.0005",
    rentalReturn: "returned-validation-rental",
    warrantyClaim: "claimed-validation-warranty",
    warrantyResolution: "resolved-validation-warranty",
    warrantyExpiresDays: "0",
    supportCategory: "billing",
    supportResponse: "responded-validation-support",
    supportClose: "closed-validation-support",
    accessRole: "billing-operator",
    accessApproval: "approved-validation-access",
    accessRevoke: "revoked-validation-access",
  },
  {
    memoAmount: "0.004",
    batchCircleAmount: "0.002",
  ...
  },
  {
    ...
    milestoneSubmission: "submitted-validation-slice",
    expenseTarget: "0.011",
  ...
  },
  {
    ...
    vaultWithdraw: "0.001",
    pollChoice: "Yes",
    pollReason: "validates the final scenario",
...
function issuedTokenContract(tokenPreset: ValidationPlan["tokenPreset"]): string {
  return tokenPreset === "SKIPIO" ? SKIPIO_CONTRACT : ARCP_CONTRACT;
}

function devWalletTransferFromCommand(tokenPreset: ValidationPlan["tokenPreset"], amount: string): string {
  return [
...
const planIndex = (dayOfYear(cycleDate) - 1) % validationPlans.length;
const plan = validationPlans[planIndex];
const productPlan = productPlans[planIndex];
const memoReference = `arc-receipt-${cycleDate}-v${planIndex + 1}`;
const invoiceLabel = `Arc Validation Invoice ${cycleDate} v${planIndex + 1}`;
...
const steps: Step[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      "Use the hardened deployment above, then create a campaign for this validation case.",
    ],
  ...
  {
    title: "35. ArcAirdrop Finalize Campaign",
    url: `${BASE_URL}/public/arc-airdrop.html`,
    fields: [
      `Contract: ${arcAirdropContract || "use the saved ArcAirdropCampaign contract from step 33"}`,
      `Label: ${airdropLabel}`,
      "The remaining balance can only return to the campaign owner.",
      "After the campaign expires, click Refresh, then Finalize & Refund.",
    ],
    proof: "Verify closeCampaign receipt, owner refund, and final remaining balance.",
  },
  {
...
console.log("Arc testnet regression checklist");
console.log(`Date: ${cycleDate}`);
console.log(`Variant: ${planIndex + 1}/${validationPlans.length}`);
console.log("Purpose: manually validate permissions, balances, state transitions, and receipts across Arc testnet features.");
...
console.log("Review each receipt and retain only the evidence needed for private QA records.");
