...
const targets = {
  ...
  "arc-revenue-splitter": ["circle/arc/src/arc-revenue-splitter.ts", "circle/arc/public/arc-revenue-splitter.bundle.js"],
  "arc-usage-billing": ["circle/arc/src/arc-usage-billing.ts", "circle/arc/public/arc-usage-billing.bundle.js"],
  "arc-streaming-payroll": ["circle/arc/src/arc-streaming-payroll.ts", "circle/arc/public/arc-streaming-payroll.bundle.js"],
  "arc-refundable-payment": ["circle/arc/src/arc-refundable-payment.ts", "circle/arc/public/arc-refundable-payment.bundle.js"],
  "arc-treasury-console": ["circle/arc/src/arc-treasury-console.ts", "circle/arc/public/arc-treasury-console.bundle.js"],
  "arc-merchant-settlement": ["circle/arc/src/arc-merchant-settlement.ts", "circle/arc/public/arc-merchant-settlement.bundle.js"],
  "arc-crosschain-router": ["circle/arc/src/arc-crosschain-router.ts", "circle/arc/public/arc-crosschain-router.bundle.js"],
  "arc-stablecoin-fx": ["circle/arc/src/arc-stablecoin-fx.ts", "circle/arc/public/arc-stablecoin-fx.bundle.js"],
  ...
  "arc-security-redeploy": [
    "circle/arc/src/arc-security-redeploy.ts",
    "circle/arc/public/arc-security-redeploy.bundle.js",
  ],
  "arc-rental": ["circle/arc/src/arc-rental.ts", "circle/arc/public/arc-rental.bundle.js"],
  "arc-warranty": ["circle/arc/src/arc-warranty.ts", "circle/arc/public/arc-warranty.bundle.js"],
  "arc-support-desk": ["circle/arc/src/arc-support-desk.ts", "circle/arc/public/arc-support-desk.bundle.js"],
  "arc-access": ["circle/arc/src/arc-access.ts", "circle/arc/public/arc-access.bundle.js"],
