...
var el = {
  ...
  contractSummary: document.querySelector("#contractSummary"),
  paidVolume: document.querySelector("#paidVolume"),
  invoiceForm: document.querySelector("#invoiceForm"),
  merchantName: document.querySelector("#merchantName"),
  customerName: document.querySelector("#customerName"),
  customerEmail: document.querySelector("#customerEmail"),
  amount: document.querySelector("#amount"),
  merchantWallet: document.querySelector("#merchantWallet"),
  description: document.querySelector("#description"),
  dueDate: document.querySelector("#dueDate"),
  refreshInvoices: document.querySelector("#refreshInvoices"),
